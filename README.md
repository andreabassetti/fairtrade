...
- Technologies, languages, tools, and algorithms used throughout the project: Python, Jupyter notebook, RandomForestClassifier, PostgresSQL, SQLAlchemy, Tableau, and Google slides.
